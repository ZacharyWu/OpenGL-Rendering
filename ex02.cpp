...
/*
 * Linux:
 * g++ ex02.cpp -o ex02APP -lGLEW -lglut -lGLU -lGL
 * Mac:
 * g++ ex02.cpp -o ex02APP -framework GLUT -framework OpenGL -framework Cocoa
 * g++ ex02.cpp -o ex02APP -lGLEW -framework GLUT -framework OpenGL -framework Cocoa
 */
...
{	
	...
	// Create GPU Buffer for Vertices: Generate points to be drawn
